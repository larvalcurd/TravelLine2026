        ...
        protected override void Up( MigrationBuilder migrationBuilder )
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRoomsCount = table.Column<int>( type: "INTEGER", nullable: false ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestName = table.Column<string>( type: "TEXT", maxLength: 300, nullable: false ),
                    GuestPhoneNumber = table.Column<string>( type: "TEXT", maxLength: 20, nullable: false ),
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Reservations",
                columns: new[] { "RoomTypeId", "IsCanceled", "ArrivalDate", "DepartureDate" } );

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_IsCanceled",
                table: "Reservations",
                column: "IsCanceled" );
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypes_PropertyId_DailyPrice",
                table: "RoomTypes",
                columns: new[] { "PropertyId", "DailyPrice" } );
        }
